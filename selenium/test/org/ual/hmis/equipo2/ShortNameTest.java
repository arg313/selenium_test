...
public class ShortNameTest {
  ...
  public void shortName() {
    ...
    // 6 | click | id=username.errors | 
    driver.findElement(By.id("username.errors")).click();
    // 7 | assertText | id=username.errors | Please use between 6 and 32 characters.
    assertThat(driver.findElement(By.id("username.errors")).getText(), is("Please use between 6 and 32 characters."));
    // 8 | click | css=.btn | 
    driver.findElement(By.cssSelector(".btn")).click();
  }
}
