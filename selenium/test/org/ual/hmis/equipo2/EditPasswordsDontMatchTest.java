...
import java.net.URL;
public class EditPasswordsDontMatchTest {
  ...
  @Test
  public void editPasswordsDontMatch() {
    // Test name: editPasswordsDontMatch
    ...
    // 10 | click | id=editprofileform | 
    driver.findElement(By.id("editprofileform")).click();
    // 11 | assertText | id=passwordConfirm.errors | These passwords don't match.
