...
import java.net.URL;
public class PasswordsDontMatchTest {
...
//	  vars = new HashMap<String, Object>();
  ...
  public void passwordsDontMatch() {
    // Test name: passwordsDontMatch
    // Step # | name | target | value
    // 1 | open | /login | 
    driver.get("http://seleniumweb.northeurope.cloudapp.azure.com/");
    // 2 | setWindowSize | 1219x648 | 
    driver.manage().window().setSize(new Dimension(1219, 648));
    ...
    // 7 | type | id=passwordConfirm | h
    driver.findElement(By.id("passwordConfirm")).sendKeys("h");
    // 8 | click | css=.btn | 
    driver.findElement(By.cssSelector(".btn")).click();
    // 9 | click | id=userForm | 
    driver.findElement(By.id("userForm")).click();
    
    // 10 | assertText | id=passwordConfirm.errors | These passwords don't match.
